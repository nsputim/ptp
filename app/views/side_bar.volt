...
{#                <div class="side-user">
                ...
                <ul class="cl-vnavigation">
                    <li><a href="#"><i class="fa fa-tags fa-fw"></i><span>Каталог</span></a>
                        <ul class="sub-menu">
                            <li class="{% if x_url == "catalog/category" %}active{% endif %}"><a href="/catalog/category">Категории</a></li>
                            <li class="{% if x_url == "catalog/goods" %}active{% endif %}"><a href="/catalog/goods">Товары</a></li>
                        </ul>
                    </li>
                    <li><a href="#"><i class="fa fa-shopping-cart"></i><span>Продажи</span></a>
                        <ul class="sub-menu">
                            <li class="{% if x_url == "shop/order" %}active{% endif %}"><a href="/shop/order"><span class="label label-primary pull-right">+2</span>Заказы</a></li>
                            <li class="{% if x_url == "shop/customer" %}active{% endif %}"><a href="/shop/customer">Покупатели</a></li>
                        </ul>
                    </li>
{#                    <li><a href="#"><i class="fa fa-home"></i><span>Dashboard</span></a>
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="dashboard2.html"><span class="label label-primary pull-right">New</span>Version 2</a>
                            </li>
                        </ul>
                    </li>
